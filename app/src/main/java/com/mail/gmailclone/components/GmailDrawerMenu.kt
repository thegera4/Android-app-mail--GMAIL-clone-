...
import com.mail.gmailclone.models.DrawerMenuData
import com.mail.gmailclone.models.MailData
...
fun GmailDrawerMenu(scrollState: ScrollState){
    ...
    Column (Modifier.verticalScroll(scrollState)){
        Text(text = "GEmail", color = androidx.compose.ui.graphics.Color.Red,
...
@Composable
fun MailDrawerPreview(){
    GmailDrawerMenu(scrollState = rememberScrollState())
}
