...
val accountList = listOf(
    Account(icon = R.drawable.email, userName = "Gerardo Medellin",
        email = "thegera4@hotmail.com", unReadMails = 99),
    Account(userName = "Chris Morty", email = "chris@gmail.com", unReadMails = 80),
    Account(userName = "Jane Jett", email = "jane@hotmail.com", unReadMails = 99),
)